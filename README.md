...
It well suited to build sites hosted on services like Github Pages or Amazon's S3. It is 
...
+ [mkslide](dosc/mkslide.html) -- a HTML slide generator based on the approach in _mkpage_
